...
export default function WhoIsItFor() {
  return (
    <section className="py-24 bg-[#faf8f5] border-b border-[#e5dfd5] relative bg-grain">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 border-b border-[#e5dfd5] pb-4 mb-8 font-mono text-[11px] text-[#7a8595] uppercase tracking-[0.25em]">
          <div className="flex items-center gap-3">
            <span className="text-[#7b1824] font-bold">08</span>
        ...
        <div className="border-b border-[#e5dfd5] pb-12 mb-14">
          <div className="space-y-2 mb-8">
            <div className="font-mono text-xs text-[#a3adb8] uppercase tracking-widest line-through">
          ...
          <h2 className="font-serif text-3xl sm:text-5xl md:text-6xl text-[#0e141e] uppercase tracking-tight font-normal max-w-4xl leading-tight">
            FOR ANYONE WHO WANTS TO <br />
            <span className="text-[#7b1824] font-semibold border-b-2 border-[#7b1824] pb-1 inline-block">
              THINK BETTER.
            </span>
          </h2>

          <p className="font-sans text-base sm:text-lg text-[#3e4856] mt-6 max-w-3xl leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {DISCIPLINES.map((item) => {
            ...
            return (
              <div
                key={item.discipline}
                className="bg-white border border-[#e5dfd5] p-6 hover:border-[#7b1824] transition-all duration-300 flex flex-col justify-between shadow-sm hover:shadow-xl rounded-sm ring-1 ring-[#c29236]/10"
              >
                <div>
                  <div className="flex items-center gap-3 border-b border-[#e5dfd5] pb-4 mb-4">
                    <div className="w-8 h-8 bg-[#faf8f5] border border-[#c29236]/30 flex items-center justify-center text-[#7b1824] shrink-0 rounded-sm shadow-sm">
                      <IconComp className="w-4 h-4 text-[#7b1824]" />
                    </div>
                    <h3 className="font-serif text-lg font-bold text-[#0e141e] uppercase tracking-tight">
                      {item.discipline}
                    </h3>
                  </div>

                  <p className="text-xs text-[#5c6776] font-sans leading-relaxed mb-4">
                    {item.why}
                  </p>
                </div>

                <div className="pt-3 border-t border-[#e5dfd5] font-mono text-[11px] text-[#7a8595]">
                  <span className="text-[#7b1824] font-bold block mb-1">Applied Crucible Value:</span>
                  <span className="text-[#3e4856] font-medium">{item.crossover}</span>
                </div>
              </div>
            );
          })}
